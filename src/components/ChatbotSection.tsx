...
5. **Step 5: Emergency Red Flags**  
   • Seek medical care if high fever, spreading red streaks, pus discharge, or facial swelling occurs.`,
    ...
    if (isSIHQuery) {
      ...
      if (language === 'hi' || isHinglish) {
        return {
          text: `क्योंकि आपका प्रोजेक्ट **स्मार्ट इंडिया हैकाथॉन (SIH)** के लिए **बीमारी जागरूकता के लिए एआई-संचालित जन स्वास्थ्य चैटबॉट** है, इसलिए जज मुख्य रूप से आपकी तकनीकी समझ, व्यवहार्यता, नवाचार और सुरक्षा का परीक्षण करेंगे। यहाँ सबसे आम प्रश्न और उनके ठोस उत्तर दिए गए हैं:\n\n**1. आपका प्रोजेक्ट किस समस्या का समाधान करता है?**\n**उत्तर:**\nहमारा चैटबॉट 24×7 स्वास्थ्य जागरूकता, लक्षण मार्गदर्शन, निवारक देखभाल जानकारी और बीमारी शिक्षा प्रदान करता है, विशेष रूप से ग्रामीण और वंचित समुदायों के लिए जहाँ स्वास्थ्य पेशेवरों तक पहुँच सीमित है।\n\n---\n\n**2. आपने AI को क्यों चुना?**\n**उत्तर:**\nAI प्राकृतिक भाषा को समझता है, त्वरित उत्तर देता है, कई भाषाओं का समर्थन करता है और एक साथ हजारों उपयोगकर्ताओं की सहायता कर सकता है, जिससे स्वास्थ्य जानकारी अधिक सुलभ हो जाती है।\n\n---\n\n**3. आपका चैटबॉट ChatGPT या Google से कैसे अलग है?**\n**उत्तर:**\nहमारा चैटबॉट केवल जन स्वास्थ्य पर केंद्रित है। यह विश्वसनीय चिकित्सा ज्ञान का उपयोग करता है, संरचित स्वास्थ्य मार्गदर्शन प्रदान करता है और बिना किसी अनावश्यक भटकाव के लक्षण मूल्यांकन प्रदान करता है।`,
          sources: ['SIH 2026 Project Presentation Repository', 'HealthAI Technical Architecture Whitepaper'],
          riskBadge: 'Low' as const
        };
      }
    ...
    // Dengue Fever
    if (textLower.includes('dengue') || textLower.includes('డెంగ్యూ') || textLower.includes('डेंगू')) {
      if (language === 'te' || isTEnglish) {
        return {
...
తీవ్రమైన కడుపు నొప్పి, నిరంతర వాంతులు, ముక్కు/చిగుళ్ళ నుండి రక్తస్రావం ఉంటే అపాయింట్‌మెంట్ కోసం ఆగకుండా వెంటనే హాస్పిటల్ ఎమర్జెన్సీ వార్డుకు వెళ్ళండి.`,
      ...
      if (language === 'hi' || isHinglish) {
        return {
          text: `### 🦟 डेंगू बुखार चिकित्सा मार्गदर्शन और डॉक्टर से मिलने से पहले की कार्य योजना

#### 1. मुख्य लक्षण:
• **अचानक तेज बुखार:** 104°F (40°C) तक बुखार होना।
• **आंखों के पीछे दर्द:** आंखों के पीछे तेज दर्द, मांसपेशियों और जोड़ों में दर्द।
• **त्वचा पर चक्कतें:** बुखार के 2-5 दिनों के बाद लाल रंग के चकत्ते निकलना।

---

### 🏥 डॉक्टर से मिलने तक चरण-दर-चरण प्रक्रिया:

1. **Step 1: आराम और हाइड्रेशन (0–30 मिनट)**  
   • तुरंत शारीरिक मेहनत बंद करें और हवादार कमरे में आराम करें।

2. **Step 2: सुरक्षित हाइड्रेशन और दवाएं**  
   • हर घंटे ORS, नारियल पानी या साफ पानी 200-250 ml पिएं। बुखार के लिए केवल पैरासिटामोल (Paracetamol) लें।  
   • ⛔ **कड़ी चेतावनी:** एस्पिरिन (Aspirin) या इबूप्रोफेन (Ibuprofen) न लें (इससे रक्तस्राव का खतरा बढ़ता है)।

3. **Step 3: प्लेटलेट्स और रक्त परीक्षण**  
   • डॉक्टर की सलाह पर प्लेटलेट्स काउंट और सीबीसी (CBC) टेस्ट करवाएं।

4. **Step 4: आपातकालीन चेतावनी**  
   • पेट में तेज दर्द, लगातार उल्टी, नाक या मसूड़ों से खून आने पर तुरंत अस्पताल के इमरजेंसी (ER) जाएं!`,
          sources: ['WHO डेंगू गाइडलाइंस 2026', 'CDC पब्लिक हेल्थ प्रोटोकॉल'],
          riskBadge: 'Moderate' as const
        };
      }
      return {
...
Proceed directly to Emergency ER if experiencing severe abdominal pain, persistent vomiting, blood in vomit/stool, mucosal bleeding (gums/nose), or extreme lethargy.`,
    ...
    // Malaria
    if (textLower.includes('malaria') || textLower.includes('మలేరియా') || textLower.includes('मलेरिया')) {
      if (language === 'te' || isTEnglish) {
        return {
          text: `### 🦟 మలేరియా వైద్య మార్గదర్శకం & నివారణ చర్యలు

#### 1. ప్రధాన లక్షణాలు:
• చలి జ్వరం, తీవ్రమైన వణుకు, అధికంగా చెమటలు పట్టడం మరియు శరీర బలహీనత.

---

### 🏥 డాక్టర్‌ను కలిసే వరకు పాటించవలసిన దశలవారీ చర్యలు:

1. **Step 1: వణుకు మరియు జ్వరం నియంత్రణ (0–1 గంట)**  
   • చలి పెట్టినప్పుడు వెచ్చని దుప్పటి కప్పండి. జ్వరం తీవ్రమైనప్పుడు గోరువెచ్చని నీటితో ఒళ్ళు తుడవండి.

2. **Step 2: ద్రవ పదార్థాలు & సురక్షిత మందులు**  
   • ORS ద్రవాలు క్రమం తప్పకుండా తాగించండి. జ్వరం తగ్గడానికి పారాసిటమాల్ మాత్రమే వాడండి. రక్త పరీక్ష లేకుండా మందులు వాడకండి.

3. **Step 3: రక్త పరీక్ష (Blood Test)**  
   • ల్యాబ్‌లో వెంటనే Blood Smear లేదా RDT పరీక్ష చేయించండి.

4. **Step 4: అత్యవసర హెచ్చరికలు**  
   • కళ్ళు/చర్మం పసుపు రంగులోకి మారడం, మూత్రం నల్లగా రావడం, శ్వాస తీసుకోవడంలో ఇబ్బంది ఉంటే వెంటనే ఆసుపత్రికి వెళ్ళండి!`,
      ...
      if (language === 'hi' || isHinglish) {
        return {
          text: `### 🦟 मलेरिया चिकित्सा मार्गदर्शन और डॉक्टर से मिलने से पहले की कार्य योजना

#### 1. प्राथमिक लक्षण:
• चक्रानुक्रम में तेज बुखार, तेज ठंड/कंपकंपी, अत्यधिक पसीना और शरीर में कमजोरी।

---

### 🏥 डॉक्टर से मिलने तक चरण-दर-चरण प्रक्रिया:

1. **Step 1: कंपकंपी और बुखार का प्रबंधन (0–1 घंटा)**  
   • कंपकंपी के दौरान मरीज को गर्म कपड़े या कंबल से ढके। जब बुखार तेज हो, तो शरीर का तापमान कम करने के लिए गुनगुने पानी की पट्टियां लगाएं।

2. **Step 2: हाइड्रेशन और सुरक्षित दर्द निवारक**  
   • ORS और इलेक्ट्रोलाइट तरल पदार्थ लगातार पिलाएं। बुखार नियंत्रण के लिए केवल पैरासिटामोल (Paracetamol) लें। बिना रक्त जांच के कोई भी एंटीबायोटिक या मलेरिया की दवा न लें।

3. **Step 3: रक्त जांच कराएं**  
   • लैब में तुरंत **ब्लड स्मियर (Blood Smear)** या **रैपिड डायग्नोस्टिक टेस्ट (RDT)** करवाएं।

4. **Step 4: आपातकालीन रेड फ्लैग**  
   • अत्यधिक पीलिया (पीली आंखें/त्वचा), गहरा मूत्र, सांस लेने में कठिनाई या अत्यधिक सुस्ती होने पर तुरंत अस्पताल के आपातकालीन विभाग (ER) में ले जाएं!`,
          sources: ['World Malaria Report 2026', 'CDC मलेरिया प्रोटोकॉल'],
          riskBadge: 'Moderate' as const
        };
      }
      return {
...
🚨 **Emergency Signs:** Severe jaundice (yellow eyes/skin), dark urine, difficulty breathing, or extreme drowsiness require immediate hospital ER admission.`,
    ...
    if (textLower.includes('fever') || textLower.includes('temp') || textLower.includes('జ్వరం') || textLower.includes('बुखार')) {
      if (language === 'te' || isTEnglish) {
        return {
          text: `### 🌡️ జ్వరం సంపూర్ణ వైద్య అంచనా & నివారణ చర్యలు

#### 1. జ్వరం తీవ్రత స్థాయిలు:
• **తక్కువ జ్వరం:** 99.5°F - 100.9°F → ద్రవాలు తాగుతూ పరిశీలించండి.
• **మధ్యస్థ జ్వరం:** 101°F - 102.9°F → పారాసిటమాల్ & గోరువెచ్చని నీటి పట్టీలు.
• **తీవ్రమైన జ్వరం:** ≥ 103°F → వెంటనే డాక్టర్‌ను సంప్రదించండి.

---

### 🏥 డాక్టర్‌ను కలిసే వరకు పాటించవలసిన దశలవారీ చర్యలు:

1. **Step 1: శరీరాన్ని చల్లబరచడం & విశ్రాంతి (0–30 నిమిషాలు)**  
   • గాలి వెలుతురు ఉన్న గదిలో విశ్రాంతి తీసుకోండి. నొసలు, చంకలు మరియు మెడపై గోరువెచ్చని నీటి గుడ్డతో తుడవండి.

2. **Step 2: ద్రవ పదార్థాలు & సురక్షిత మందులు**  
   • రోజుకు 2.5–3 లీటర్ల ద్రవాలు (ORS, సూప్, మంచి నీరు) తాగండి. జ్వరం 101°F కంటే ఎక్కువ ఉంటే పారాసిటమాల్ వాడండి.

3. **Step 3: అత్యవసర హెచ్చరికలు**  
   • మెడ బిగుతుగా మారడం, శ్వాస తీసుకోవడంలో తీవ్రమైన కష్టం, 72 గంటల కంటే ఎక్కువ జ్వరం ఉంటే వెంటనే ఎమర్జెన్సీకి వెళ్ళండి!`,
          sources: ['CDC Fever Triage Guide', 'NHS Clinical Guidelines'],
          riskBadge: 'Urgent' as const
        };
      }
      if (language === 'hi' || isHinglish) {
        return {
          text: `### 🌡️ बुखार मूल्यांकन एवं डॉक्टर से मिलने से पहले की कार्य योजना

#### 1. बुखार की गंभीरता:
• **हल्का बुखार:** 99.5°F - 100.9°F (37.5°C - 38.3°C) → तरल पदार्थ पिएं और निगरानी करें।
• **मध्यम बुखार:** 101°F - 102.9°F (38.3°C - 39.4°C) → पैरासिटामोल और गुनगुने पानी की पट्टियां लगाएं।
• **तेज बुखार:** ≥ 103°F (39.4°C) → तुरंत डॉक्टर से परामर्श लें।

---

### 🏥 डॉक्टर से मिलने तक चरण-दर-चरण प्रक्रिया:

1. **Step 1: ठंडा करना और आराम (0–30 मिनट)**  
   • हवादार कमरे में आराम करें। माथे, बगल और गर्दन पर गुनगुने पानी से गीली पट्टियां लगाएं।

2. **Step 2: हाइड्रेशन और सुरक्षित दवाएं**  
   • रोज 2.5–3 लीटर तरल पदार्थ (ORS, सूप, पानी) पिएं। बुखार > 101°F होने पर पैरासिटामोल लें।

3. **Step 3: आपातकालीन रेड फ्लैग**  
   • गर्दन में अकड़न, सांस लेने में कठिनाई, होंठ नीले पड़ना या 72 घंटे से ज्यादा बुखार रहने पर तुरंत इमरजेंसी जाएं!`,
          sources: ['CDC बुखार गाइडलाइन', 'NHS क्लिनिकल गाइडलाइंस'],
          riskBadge: 'Urgent' as const
        };
      }
      return {
...
🚨 **Emergency Alert:** If experiencing deep rapid breathing, fruity breath odor, nausea, or confusion (Diabetic Ketoacidosis - DKA), seek emergency hospital care immediately.`,
    ...
    if (
      ...
      textLower.includes('రక్తం') ||
      textLower.includes('खून')
    ) {
      if (language === 'te' || isTEnglish) {
        return {
          text: `### 🩸 అత్యవసర ప్రథమ చికిత్స: రక్తస్రావం వెంటనే ఎలా ఆపాలి

#### ⚡ తక్షణ చర్యలు (మొదటి 60 సెకన్లు):

1. **Step 1: నేరుగా మరియు గట్టిగా నొక్కండి (Direct Pressure)**  
   • శుభ్రమైన గుడ్డ లేదా గాజ్ ప్యాడ్‌ను గాయంపై **నేరుగా మరియు గట్టిగా** నొక్కి పట్టుకోండి.  
   • **కనీసం 5 నుండి 10 నిమిషాలు ఎడతెరిపి లేకుండా నొక్కి పట్టుకోండి.** గాయాన్ని పదే పదే తెరచి చూడకండి!

2. **Step 2: దెబ్బతిన్న అవయవాన్ని పైకి ఎత్తండి**  
   • చెయ్యి లేదా కాలుకి దెబ్బ తగిలితే, గుండె మట్టం కంటే పైకి ఎత్తి పట్టుకోండి.

3. **Step 3: అత్యవసర హెచ్చరిక**  
   • 10 నిమిషాలు నొక్కి పట్టుకున్నా రక్తం ఆగకపోతే వెంటనే **108 / 112 అంబులెన్స్** కు కాల్ చేయండి!`,
          sources: ['American Red Cross Emergency First Aid', 'WHO Emergency Wound Care'],
          riskBadge: 'Urgent' as const
        };
      }
      if (language === 'hi' || isHinglish) {
        return {
          text: `### 🩸 आपातकालीन प्राथमिक चिकित्सा: खून बहना तुरंत कैसे रोकें

#### ⚡ तत्काल कार्रवाई (पहले 60 सेकंड):

1. **Step 1: सीधा दबाव (Direct Pressure)**  
   • घाव पर साफ कपड़ा, कॉटन या रोगाणुरहित पट्टी **सीधे और कसकर** दबाएं।  
   • **कम से कम 5 से 10 मिनट तक लगातार दबाव बनाए रखें।** कपड़ा हटाकर घाव बार-बार न देखें!

2. **Step 2: चोट लगे अंग को ऊपर उठाएं**  
   • यदि चोट हाथ या पैर में है, तो उसे दिल के स्तर से ऊपर उठाएं (जब तक कि हड्डी टूटने का संदेह न हो)।

3. **Step 3: आपातकालीन रेड फ्लैग**  
   • यदि 10 मिनट दबाव के बाद भी खून बहना न रुके या खून की धारा तेजी से फूटे, तो तुरंत **108 / 112 एम्बुलेंस** को कॉल करें!`,
          sources: ['American Red Cross Emergency First Aid', 'WHO इमरजेंसी वूंड केयर'],
          riskBadge: 'Urgent' as const
        };
      }
      return {
